        ...
        <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-sm">
            ...
            <form method="POST" action="{{ route('income.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="category" list="category-list" value="{{ old('category') }}" placeholder="Type category name..." required class="w-full rounded-xl border-slate-200 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="payment_method" list="payment-method-list" value="{{ old('payment_method') }}" placeholder="e.g. Cash, Bank..." class="w-full rounded-xl border-slate-200 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500">
