    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-sm">
            <div class="mb-6 pb-4 border-b border-slate-100 flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold text-slate-900">Record New Expense</h2>
                    <p class="text-sm text-slate-500">Fill in details for your spending.</p>
                </div>
            ...
            <form method="POST" action="{{ route('expense.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0.01" name="amount" value="{{ old('amount') }}" placeholder="0.00" required class="pl-8 w-full rounded-xl border-slate-200 text-slate-900 font-semibold focus:border-rose-500 focus:ring-rose-500">
                    </div>
                ...
                <div>
                    ...
                    <input type="text" name="description" value="{{ old('description') }}" placeholder="Short summary (e.g. Grocery Shopping)" class="w-full rounded-xl border-slate-200 text-slate-900 focus:border-rose-500 focus:ring-rose-500">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="date" value="{{ old('date', date('Y-m-d')) }}" required class="w-full rounded-xl border-slate-200 text-slate-900 focus:border-rose-500 focus:ring-rose-500">
                ...
                <div>
                    ...
                    <textarea name="note" rows="3" placeholder="Optional notes or context..." class="w-full rounded-xl border-slate-200 text-slate-900 focus:border-rose-500 focus:ring-rose-500">{{ old('note') }}</textarea>
                ...
                <div class="pt-4 flex items-center justify-end space-x-3">
                    ...
                    <button type="submit" class="px-6 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-semibold text-sm shadow-md shadow-rose-600/20">
                        Save Expense
                    </button>
                </div>
            </form>
